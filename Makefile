...
particleSystemGpu.o:particleSystemGpu.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

particleSystemCpu.o:particleSystemCpu.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

particleSystem_cuda.o:particleSystem_cuda.cu particles_kernel_impl.cuh
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
...
particles: particleSystemGpu.o particleSystemCpu.o particleSystem_cuda.o particles.o render_particles.o shaders.o scalarfield.o marchingCubes.o marchingCubes_kernel.o vtk.o
